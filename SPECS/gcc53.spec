...
Patch:	 Unlink-the-response-file.patch
...
%description
The gcc package contains the GNU Compiler Collection version 5.3.
...
echo "gcc-%{version}-%{release}.%{_arch}" | tee %{buildroot}/opt/gcc-%{version}/%{_lib}/gcc/%{gcc_target_platform}/rpmver
  ...
  chmod a+x %{buildroot}/%{_bindir}/gcc53
...
%changelog
* Sat Mar 26 2016 David Vasquez <davidjeremias82@gmail.com> 5.3.0-1
- New package
